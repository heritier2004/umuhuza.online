...
<footer class="footer text-white py-5 mt-5">
  <div class="container row g-4">
    <div class="col-md-4"><h5>About Rwanda Marketplace</h5><p class="text-light">Rwanda Marketplace is a local property and service platform that helps buyers, renters, agents, and service providers discover trusted opportunities, request help, and connect faster in Rwanda.</p></div>
    ...
    <div class="col-md-4"><h5>Contact</h5><p class="mb-1 text-light">Call: +250 788 000 000</p><p class="mb-1 text-light">WhatsApp: +250 788 000 000</p><p class="mb-0 text-light">Terms & Privacy</p></div>
  </div>
</footer>
<?php endif; ?>
